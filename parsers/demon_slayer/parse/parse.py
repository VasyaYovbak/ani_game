...
def parse_demon_slayer(url: str):
...
demon_slayer_url = 'https://comicvine.gamespot.com/kimetsu-no-yaiba/4050-90821/characters/?page='
...
for i in range(start_page, end_page + 1):
    demon_slayer_data = parse_demon_slayer(demon_slayer_url + str(i))
    list_of_dicts.append(demon_slayer_data)

keys = ['full_name', 'image', 'appearance']
demon_slayer_characters = merge_dicts(list_of_dicts, keys)
# print(demon_slayer_characters)
